...
Revision ID: a298b748e169
Revises: 
Create Date: 2025-07-14 18:34:54.436215
...
def upgrade() -> None:
    ...
    sa.Column('page_id', sa.Integer(), nullable=False, comment='当前权限对应的页面ID'),
